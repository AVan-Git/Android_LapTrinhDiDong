    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder myDialog = new AlertDialog.Builder(ProductActivity.this);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int update_Uri = getContentResolver().update(product, values, "id = " + id, null);
                if (update_Uri > 0) {
...
//                }
        ...
        btnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri product_uri = Uri.parse(uri);
                Cursor cursor  = getContentResolver().query(product_uri, null, null, null, "name");
                cursor.moveToFirst();
...
//                    cursor.moveToFirst();
    ...
    public boolean check_data() {
        ...
        Log.e("TAG", "check_data: "+ cursor);
        cursor.moveToFirst();

        if (!cursor.isAfterLast()) {
            do {
                if (Integer.parseInt(ma_check) == cursor.getInt(0))
                {
